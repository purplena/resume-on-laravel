<x-page-layout>
    <section class="w-full px-6 py-10 mt-navbarMargin" id="contact">
        <div class="md:flex md:gap-x-8 max-w-5xl mr-auto ml-auto">
            <div class="w-full md:w-1/2 flex flex-col gap-2 mb-4 md:mb-0">
                ...
                <p>
                    ...
                    <span class="text-main-500 font-bold hover:text-main-700">elena.molano14@gmail.com</span>
                </p>
            </div>
            <div class="w-full md:w-1/2  bg-main-200 drop-shadow-sm hover:drop-shadow-lg px-8 py-6 rounded-3xl">
                        ...
                        <div class="sm:col-span-4">
                            ...
                            <div class="mt-2">
                                <input type="text" name="name" id="name"
                                    class="block w-full rounded border-0 bg-white py-1.5 text-gray-900  ring-1 {{ $errors->has('name') ? 'ring-rose-500' : 'ring-gray-300' }} focus:ring-1 focus:ring-inset focus:ring-purple-600 placeholder:text-gray-400 placeholder:text-[14px]"
                        ...
                        <div class="sm:col-span-4">
                            ...
                            <div class="mt-2">
                                <input type="email" name="email" id="email"
                                    class="block w-full rounded border-0 bg-white py-1.5 text-gray-900 ring-1 {{ $errors->has('email') ? 'ring-rose-500' : 'ring-gray-300' }} focus:ring-1 focus:ring-inset focus:ring-purple-600 placeholder:text-gray-400 placeholder:text-[14px]"
