<div class="flex flex-row gap-1">
    @foreach ($available_locales as $locale_name => $available_locale)
        ...
        @else
            <a class="language-switcher-link social-link-transition block cursor-pointer w-[28px] h-[28px] rounded-full border border-solid border-main-500 relative text-main-500 bg-main-200"
